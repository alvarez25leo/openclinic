...
public class Audiometry {
    ...
    public static HearingLoss calculateHearingloss(int age,String gender){
        ...
        loss.setLoss0250(low.getLoss0250()+(high.getLoss0250()-low.getLoss0250())*(age-lowAge)/(highAge-lowAge));
        loss.setLoss0500(low.getLoss0500()+(high.getLoss0500()-low.getLoss0500())*(age-lowAge)/(highAge-lowAge));
