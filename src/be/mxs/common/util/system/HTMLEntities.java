...
public class HTMLEntities {
    ...
    private static HashMap javascriptEscape;
    static {
        javascriptEscape = new HashMap();
        javascriptEscape.put("&agrave;", "\\u00E0");
        javascriptEscape.put("&Agrave;", "\\u00C0");
        javascriptEscape.put("&acirc;", "\\u00E2");
        javascriptEscape.put("&auml;", "\\u00E4");
        javascriptEscape.put("&Auml;", "\\u00C4");
        javascriptEscape.put("&Acirc;", "\\u00C2");
        javascriptEscape.put("&aring;", "\\u00E5");
        javascriptEscape.put("&Aring;", "\\u00C5");
        javascriptEscape.put("&aelig;", "\\u00E6");
        javascriptEscape.put("&AElig;", "\\u00C6");
        javascriptEscape.put("&ccedil;", "\\u00E7");
        javascriptEscape.put("&Ccedil;", "\\u00C7");
        javascriptEscape.put("&eacute;", "\\u00E9");
        javascriptEscape.put("&Eacute;", "\\u00C9");
        javascriptEscape.put("&egrave;", "\\u00E8");
        javascriptEscape.put("&Egrave;", "\\u00C8");
        javascriptEscape.put("&ecirc;", "\\u00EA");
        javascriptEscape.put("&Ecirc;", "\\u00CA");
        javascriptEscape.put("&euml;", "\\u00EB");
        javascriptEscape.put("&Euml;", "\\u00CB");
        javascriptEscape.put("&iuml;", "\\u00EF");
        javascriptEscape.put("&Iuml;", "\\u00CF");
        javascriptEscape.put("&ocirc;", "\\u00F4");
        javascriptEscape.put("&Ocirc;", "\\u00D4");
        javascriptEscape.put("&ouml;", "\\u00F6");
        javascriptEscape.put("&Ouml;", "\\u00D6");
        javascriptEscape.put("&oslash;", "\\u00F8");
        javascriptEscape.put("&Oslash;", "\\u00D8");
        javascriptEscape.put("&szlig;", "\\u00DF");
        javascriptEscape.put("&ugrave;", "\\u00F9");
        javascriptEscape.put("&Ugrave;", "\\u00D9");
        javascriptEscape.put("&ucirc;", "\\u00FB");
        javascriptEscape.put("&Ucirc;", "\\u00DB");
        javascriptEscape.put("&uuml;", "\\u00FC");
        javascriptEscape.put("&nbsp;", "\\u00A0");
    ...
    public static String javascriptUnescapeHTML(String source) {
        source = htmlentities(source);
        return unescapeJavascript(source, 1);
    }
    public static final String unescapeJavascript(String source, int start) {
        try {
            int i, j;
            ...
            if (i > -1) {
                ...
                if (j > i) {
                    ...
                    String value = (String) javascriptEscape.get(entityToLookFor);
                    if (value != null) {
                        source = new StringBuffer().append(source.substring(0, i))
                                .append(value)
                                .append(source.substring(j + 1))
                                .toString();
                        return unescapeJavascript(source, i + 1); // recursive call
                    }
                }
            }
        } catch (Exception e) {
