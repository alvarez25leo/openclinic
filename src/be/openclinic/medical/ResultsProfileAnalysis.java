 ...
 */
public class ResultsProfileAnalysis {
    ...
    public static void deleteByProfileID(int iProfileID){
        ...
        String sDelete = "DELETE FROM ResultProfilesAnalysis WHERE profileID = ?";
    ...
    public static void deleteByProfileIDLabID(int iProfileID, int iLabID){
        ...
        String sDelete = "DELETE FROM ResultProfilesAnalysis WHERE profileID = ? AND labID = ?";
    ...
    public void insert(){
        ...
        String sInsert = " INSERT INTO ResultProfilesAnalysis(profileID,labID,updateuserid,updatetime,comment)" +
                         " VALUES(?,?,?,?,?)";
        Connection oc_conn=MedwanQuery.getInstance().getOpenclinicConnection();
        try{
