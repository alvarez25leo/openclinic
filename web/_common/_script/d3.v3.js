d3 = function() {
  ...
  d3.layout.histogram = function() {
    var frequency = true, valeur = Number, ranger = d3_layout_histogramRange, binner = d3_layout_histogramBinSturges;
    function histogram(data, i) {
      var bins = [], values = data.map(valeur, this), range = ranger.call(this, values, i), thresholds = binner.call(this, range, values, i), bin, i = -1, n = values.length, m = thresholds.length - 1, k = frequency ? 1 : 1 / n, x;
      while (++i < m) {
        bin = bins[i] = [];
    ...
    histogram.value = function(x) {
      if (!arguments.length) return valeur;
      valeur = x;
      return histogram;
    };
