...
{ var yy, mm, dd, hh, nn, ss, vv_date=new Date(vv);
  ...
  { if (ii<365*24*60*60*1000)
    { vv_date.setTime(vv+15*24*60*60*1000);
      ...
      if (ttype==5) return(mm+"/"+yy);//You can add your own date format here
  ...
  { if (ttype==5) return(dd+"/"+mm);//You can add your own date format here
  ...
  { if (hh==0)
    ...
    { if (ttype==5) return(hh+":00");//You can add your own date format here
