...
var gcCalBG="#a7c3d8";	// the background color of the outer calendar panel.
...
var gsNavPrev="<INPUT type='button' value=' &lt; ' class='MonthNav' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<INPUT type='button' value=' &gt; ' class='MonthNav' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator

var gbHideBottom=false;	// true: hide the bottom section; false: show it with gsBottom.
var gsBottom="<A href='javascript:void(0)' class='Today' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"Today is not a selectable date!\");return false;' onmouseover='return true;' title='Today'>Today: "+gMonths[gToday[1]-1]+" "+gToday[2]+" "+gToday[0]+"</A>";	// the content of the bottom section.
...
var gcSatBG="#cfdfea";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#cfdfea";	// Sunday background color
...
var gcToggle="#ffcc00";	// the highlight color for the focused cell
