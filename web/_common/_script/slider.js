...
// options: axis: 'vertical', or 'horizontal' (default)
// callbacks: onChange(value), onSlide(value)
Control.Slider = Class.create({
  ...
  dispose: function(){
    ...
    this.handles.each(function(h){Event.stopObserving(h,"mousedown",slider.eventMouseDown);});
  },
