...
<%@page import="be.mxs.common.util.pdf.general.PDFCoveragePlanInvoiceGenerator"%>
...
<%
    ...
    try{
        ...
        PDFInvoiceGenerator pdfGenerator;
       	pdfGenerator = new PDFCoveragePlanInvoiceGenerator(activeUser,sProject,sPrintLanguage,sPrintType);
