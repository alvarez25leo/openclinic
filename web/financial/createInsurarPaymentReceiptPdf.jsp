...
<%@ page import="be.mxs.common.util.pdf.general.PDFInsurarReceiptGenerator" %>
...
<%
    ...
    try{
        ...
        PDFInsurarReceiptGenerator pdfGenerator = new PDFInsurarReceiptGenerator(activeUser,null,sProject,sPrintLanguage);
