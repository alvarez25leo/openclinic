...
<%@ page import="be.mxs.common.util.pdf.general.PDFWicketReceiptGenerator" %>
...
<%
    ...
    try{
        ...
        PDFWicketReceiptGenerator pdfGenerator = new PDFWicketReceiptGenerator(activeUser,credit,sProject,sPrintLanguage);
