...
<%
    ...
    try{
        // PDF generator
        PDFOrderTicketsGenerator ticketGenerator = new PDFOrderTicketsGenerator(activeUser,sProject);
        baosPDF = ticketGenerator.generatePDFDocumentBytes(request,sOrderUids);
