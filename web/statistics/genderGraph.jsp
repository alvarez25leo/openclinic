...
<%
	...
	try{
		...
		PreparedStatement ps = conn.prepareStatement("select gender, count(*) total"+
		                                             " from AdminView a,OC_ENCOUNTERS b"+
		                                             "  where b.OC_ENCOUNTER_BEGINDATE>=? and b.OC_ENCOUNTER_BEGINDATE<=?"+
		                                             "    and a.personid = b.oc_encounter_patientuid"+
		                                             " group by gender");
